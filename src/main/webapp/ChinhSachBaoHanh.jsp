...
-->
    ...
    <main class="ChinhSachBaoHanh">
      <div class="container policy-content">
        ...
        <p class="policy-date">
          Áp dụng cho mọi sản phẩm giày mua tại H&M - SPORT SHOES.
        </p>
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>
              Sản phẩm phải được mua trực tiếp từ hệ thống H&M hoặc các kênh
        ...
        <section class="policy-section">
          ...
          <p>
            <strong>Bước 2:</strong> Bộ phận kỹ thuật H&M kiểm tra và đánh giá
            tình trạng lỗi. Thời gian kiểm tra: <strong>3-5 ngày làm việc</strong>.
          </p>
          <p>
            <strong>Bước 3:</strong> Thông báo kết quả và tiến hành sửa chữa.
            Trong trường hợp không thể sửa chữa, H&M có thể đề xuất phương án
