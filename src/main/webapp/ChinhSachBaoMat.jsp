...
-->
    ...
    <main class="ChinhSachBaoMat">
      <div class="container policy-content">
        ...
        <p class="summary">
          <strong>H&M - SPORT SHOES</strong> cam kết bảo vệ tuyệt đối quyền
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>
              <strong>Không bán dữ liệu:</strong> H&M tuyệt đối không bán, cho
        ...
        <p class="final-note">
          ...
          <a href="mailto:hm_sport@gmail.com">hm_sport@gmail.com</a>.
        </p>
      </div>
    </main>
    <!--
