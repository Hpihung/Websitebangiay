    ...
    <main class="FAQPage">
      <div class="container faq-content">
        ...
        <p class="faq-subtitle">
          Giải đáp mọi thắc mắc của quý khách về sản phẩm và dịch vụ của H&M -
          SPORT SHOES.
        </p>
        ...
        <section class="faq-category">
          ...
          <div class="faq-item">
            <button class="faq-question">
              Làm sao tôi biết giày tại H&M là hàng chính hãng?
              <ion-icon
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>
                ...
                khách có thể tham khảo thêm trên Fanpage chính thức của H&M.
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="faq-category">
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>
                Quý khách có thể tự hủy đơn hàng trực tiếp tại website bằng cách
                truy cập vào <strong>Tài khoản > Lịch sử đơn hàng</strong>. Nút
                <strong>"Hủy đơn"</strong> sẽ xuất hiện đối với các đơn hàng
                đang ở trạng thái <strong>Chờ xác nhận (PENDING)</strong>.
              </p>
              <p>
                Trường hợp đơn hàng đã được xác nhận hoặc đang trong quá trình
                vận chuyển, quý khách vui lòng liên hệ ngay với Hotline
                <strong>0367085888</strong> để nhân viên hỗ trợ xử lý kịp thời.
              </p>
            </div>
          </div>
        </section>
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>
                ...
                đơn hàng và địa chỉ nhận hàng của quý khách. H&M thường xuyên có
        ...
        <section class="faq-category">
          ...
          <div class="faq-item">
            <button class="faq-question">
              Chính sách đổi trả hàng hóa của H&M như thế nào?
              <ion-icon
                name="chevron-down-outline"
                class="toggle-icon"
              ></ion-icon>
            ...
            <div class="faq-answer">
              <p>
                H&M áp dụng chính sách đổi hàng trong vòng
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>
                Có. Mọi sản phẩm giày chính hãng mua tại H&M đều được bảo hành
