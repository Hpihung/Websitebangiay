    ...
    <main class="HuongDanMuaHangPage">
      <div class="container guide-content">
        <h1 class="h2 guide-title" style="color: var(--rich-black-fogra-29)">
          HƯỚNG DẪN MUA HÀNG TẠI H&M - SPORT SHOES
        </h1>
        ...
        <p class="summary">
          Quy trình mua hàng tại H&M được thiết kế tối giản và nhanh chóng. Dưới
        ...
        <section class="guide-section">
          ...
          <div class="step-detail">
            ...
            <p>
              Sau khi chọn được sản phẩm ưng ý, quý khách chọn <strong>Kích cỡ</strong> và
        ...
        <section class="guide-section">
          ...
          <div class="step-detail">
            ...
            <ul>
              ...
              <li>
                Nhân viên H&M sẽ liên hệ xác nhận đơn hàng qua điện thoại trong
                vòng 24 giờ.
              </li>
              <li>
