...
public class Promotion implements Serializable {
    ...
    public Promotion(int id, String name, String slug, String discount_type, BigDecimal discount_value, LocalDateTime start_date, LocalDateTime end_date, boolean is_active, boolean is_flash_sale) {
        this.id = id;
        this.name = name;
        this.slug = slug;
        this.discount_type = discount_type;
        ...
        this.end_date = end_date;
        this.is_active = is_active;
        this.is_flash_sale = is_flash_sale;
    }
    ...
    public boolean isFlashSale() {
        return is_flash_sale;
    }

    public void setFlashSale(boolean is_flash_sale) {
        this.is_flash_sale = is_flash_sale;
    }

    // Alias for JDBI mapping column "is_active" -> setIsActive()
    public void setIsActive(boolean is_active) {
        this.is_active = is_active;
    }

    // Alias for JDBI mapping column "is_flash_sale" -> setIsFlashSale()
