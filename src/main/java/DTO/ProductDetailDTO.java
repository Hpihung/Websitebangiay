...
public class ProductDetailDTO  implements Serializable {
    ...
    public ProductDetailDTO(ProductDTO productDTO, List<Color> productColorList, List<Size> productSizeList, int stock, List<String> productImg, Brand brand, String productDes, List<ProductDTO> relatedProduct, Integer currentColorId, Integer currentSizeId) {
        this.productDTO = productDTO;
        this.productColorList = productColorList;
        this.productSizeList = productSizeList;
        this.stock = stock;
