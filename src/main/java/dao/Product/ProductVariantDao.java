...
public class ProductVariantDao {
    ...
    public List<Size> findSizesByProductAndColor(int productId, int colorId) {
        ...
        String sql = """
            SELECT DISTINCT s.*, v.stock AS stock
            FROM product_variant v
    ...
    public void insert(int productId, int sizeId, int colorId, int stock) {
        String sql = """
            INSERT INTO product_variant (product_id, size_id, color_id, stock, is_discontinue_variant)
    ...
    public void update(int productId, int oldSizeId, int oldColorId, int newSizeId, int newColorId, int stock) {
        String sql = """
            UPDATE product_variant
            SET size_id = :newSizeId, color_id = :newColorId, stock = :stock
            WHERE product_id = :productId AND size_id = :oldSizeId AND color_id = :oldColorId
        """;
        jdbi.useHandle(h -> h.createUpdate(sql)
                .bind("productId", productId)
                .bind("oldSizeId", oldSizeId)
                .bind("oldColorId", oldColorId)
                .bind("newSizeId", newSizeId)
                .bind("newColorId", newColorId)
                .bind("stock", stock)
                .execute());
    }
